...
<template>
      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://yt3.ggpht.com/yti/ADpuP3OM_eyaOVdYr1XQT2lt2P2nspljwZhKmfWtn-ywmRk=s88-c-k-c0x00ffffff-no-rj"
          />
  ...
  <div
    class="fixed top-0 right-0 w-[calc(100%-240px)] overflow-auto h-full bg-gradient-to-b from-[#1c1c1c] to-black"
  >
